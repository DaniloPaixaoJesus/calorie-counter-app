            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Comece gratuitamente e evolua quando desejar.',
                    textAlign: TextAlign.center,
                  ...
                  _PlanCard(
                    ...
                    bullets: const [
                      ...
                      'IA rápida (estimativa simplificada)',
                      'Sem login',
                  ...
                  FilledButton(
                    onPressed: () => _continueFree(context),
                    child: const Text('Continuar gratuitamente'),
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  OutlinedButton.icon(
                    onPressed: () => _openPremium(context),
                    icon: const PremiumCrownIcon(size: 18),
