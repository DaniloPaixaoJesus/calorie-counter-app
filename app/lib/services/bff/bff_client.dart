...
class BffClient {
  ...
  Future<BffResponse> get(String path) {
    return _send(method: 'GET', endpoint: resolve(path));
  }

  Future<BffResponse> post(String path, Map<String, Object?> body) {
    return _send(method: 'POST', endpoint: resolve(path), body: body);
  }

  Future<BffResponse> put(String path, Map<String, Object?> body) {
    return _send(method: 'PUT', endpoint: resolve(path), body: body);
  }
